...
if __name__ == "__main__":
    ...
    mesh_file_path_2 = './output/bunny_opacity0/train/ours_35000/fuse_post.ply'
    mesh_file_path_3 = './output/bunny_mash-2dgs/train/ours_35000/fuse_post.ply'
    ...
    cd3 = toChamferDistanceFromMeshFile(mesh_file_path_3, gt_mesh_file_path, sample_point_num, overwrite)
    print('bunny_2DGS :', cd1)
    print('bunny_opacity0 :', cd2)
    print('bunny_mash-2dgs :', cd3)
